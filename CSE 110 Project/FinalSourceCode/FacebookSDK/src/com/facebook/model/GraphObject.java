...
public interface GraphObject {
    ...
    final class Factory {
        ...
        static <U> U coerceValueToExpectedType(Object value, Class<U> expectedType,
                ParameterizedType expectedTypeAsParameterizedType) throws java.text.ParseException {
            if (value == null) {
                return null;
            }
            ...
            if (GraphObject.class.isAssignableFrom(expectedType)) {
                ...
                java.lang.reflect.Type[] actualTypeArguments = expectedTypeAsParameterizedType.getActualTypeArguments();
        ...
        private final static class GraphObjectProxy extends ProxyBase<JSONObject> {
            ...
            private final Object proxyGraphObjectGettersAndSetters(Method method, Object[] args) throws JSONException, java.text.ParseException {
                String methodName = method.getName();
                int parameterCount = method.getParameterTypes().length;
        ...
        private final static class GraphObjectListImpl<T> extends AbstractList<T> implements GraphObjectList<T> {
            ...
            public T get(int location) {
                ...
                T result = null;
				try {
					result = (T) coerceValueToExpectedType(value, itemType, null);
